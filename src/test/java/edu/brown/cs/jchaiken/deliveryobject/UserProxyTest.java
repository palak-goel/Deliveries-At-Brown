...
public class UserProxyTest {
  ...
  public void testGoodProxy() {
    ...
    final UserProxy test = new UserProxy("palak_goel@brown.edu");
  ...
  public void testBadProxy() {
    Database.setUrl("data/test.sqlite3");
    final UserProxy test = new UserProxy("d@b");
  ...
  public void testBadProxyHistory() {
    Database.setUrl("data/test.sqlite3");
    final UserProxy test = new UserProxy("test");
  ...
  public void testAccountStatus() {
    Database.setUrl("data/test.sqlite3");
    assert User.byId("jackson_chaiken@brown.edu")
  ...
  public void testRatings() {
    Database.setUrl("data/test.sqlite3");
    assertEquals(User.byId("jackson_chaiken@brown.edu").getDelivererRating(),
        5.0, .1);
    assert User.byId("jackson_chaiken@brown.edu").getOrdererRating() == 4.25;
    assertEquals(User.byId("malik_shehyrar_hasan@brown.edu").getOrdererRating(),
        5, .1);
    assertEquals(User.byId("palak_goel@brown.edu").getOrdererRating(), 4.75,
        .1);
  }
  ...
  public void testRatingsNotInDb() {
    ...
    assertEquals(User.byId("").getDelivererRating(), 5, .1);
    assertEquals(User.byId("").getOrdererRating(), 5, .1);
  }
}
