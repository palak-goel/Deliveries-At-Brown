...
public class Manager {
  ...
  private static List<Order> pendingOrders = Collections
      .synchronizedList(new ArrayList<>());
  private static Map<String, Order> jidToOrder = Collections
      .synchronizedMap(new HashMap<>());
  private static final Gson GSON = new Gson();
  private static Map<String, Session> sessionMap = Collections
      .synchronizedMap(new HashMap<>());
  private static Map<String, String> widToJid = Collections
      .synchronizedMap(new HashMap<>());
  private static final SimpleDateFormat DATE_FORMAT = new SimpleDateFormat(
      "HH:mm");
  private static Set<String> activeUsers = Collections
   ...
   * @param jid the id of the user to remove.
   */
  ...
  public static class OrderMaker implements Route {
    ...
    public Object handle(Request req, Response res) {
      ...
      final Location pickup = Location.newLocation(pLat, pLon,
          qm.value("pickup"));
      final Location dropoff = Location.newLocation(dLat, dLon,
          qm.value("dropoff"));
      builder.setOrderer(curr).setPickup(pickup).setDropoff(dropoff)
          .setPrice(price)
          .setDropoffTime((double) time.getTime() / (double) DIV)
  ...
  public static class PendingOrders implements Route {
    ...
    public Object handle(Request arg0, Response arg1) throws Exception {
      ...
      res.put("time",
          DATE_FORMAT.format(new Date((long) DIV * (int) o.getDropoffTime())));
  ...
  public static class CompletedOrder implements Route {
    ...
    public Object handle(Request arg0, Response arg1) throws Exception {
      ...
      o.getOrderer().charge(o.getPrice() + price + 3, o.getOrderItems(),
      ...
      OrderWebSocket
          .completeOrderRequester(widToJid.get(o.getOrderer().getWebId()));
