...
final class UserBean extends DeliveryObjectBean<User> implements User {
  ...
  private static Set<String> webIds = Collections
      .synchronizedSet(new HashSet<String>());

  UserBean(String email, String newName, String newPaymentId, String cellNum,
      Integer newPass, AccountStatus newStatus) {
    super(email);
    password = newPass;
    name = newName;
  ...
  public void charge(double amount, List<String> items, String pickup,
    ...
    chargeParams.put("description", "You ordered: " + list.toString()
        + " from " + pickup + " to be delivered to " + destination);
