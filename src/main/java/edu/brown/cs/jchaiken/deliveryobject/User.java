...
public interface User extends DeliveryObject {
	...
	class UserBuilder {
		...
		public User build() {
			if (id == null || name == null || paymentId == null || cell == null || pass == null || status == null
					|| dRatings == null || oRatings == null) {
				throw new IllegalArgumentException("There are parameters that have" + " not been set");
			}
	 ...
	 */
	void addDeliveryPreferences(double distance, double minimumFee, double maximumTime);
	 ...
	 *         otherwise.
	 */
	static boolean resetPassword(String id, String oldPassword, String newPassword) {
	...
	/**
	 * Returns true or false if the email/password combination matches an
